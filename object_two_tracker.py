...
flags.DEFINE_string("video1", "./data/section_cam_cut2.mp4", "path to input video1 or set to 0 for webcam")
flags.DEFINE_string("video2", "./data/number_recog_cut2.mp4", "path to input video2")
...
flags.DEFINE_string("video_mask1", "masking3.jpg", "path to input video mask")
flags.DEFINE_string("video_mask2", "masking_video_2.jpg", "path to input video mask2")
